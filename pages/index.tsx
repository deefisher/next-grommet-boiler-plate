...
export default function Home() {
    ...
    return (
        <Box flex margin={{ horizontal: 'auto' }} width={{ max: 'xlarge' }} height={{ min: '100%' }}>
            <Head>
            ...
            <Box flex role="main" pad={{ vertical: 'large' }}>
                ...
                <Paragraph fill>
                    This application is a boilerplate for using Next.js Framework, React library and the Grommet
                    Component Library.
                </Paragraph>

                <Paragraph fill>
                    The application and the page you are currently viewing is the default page that is created after
                    bootstrapping a Next.js with{' '}
                    <Anchor href="https://nextjs.org/docs/api-reference/create-next-app">Create Next App</Anchor>.
                </Paragraph>

                <Paragraph fill>
                    To the default Create Next App application we added the grommet dependency, and replaced the HTML
                    tags with actual grommet components, as a result you are viewing the same default page, with only
                    Grommet components.
                </Paragraph>

                <Paragraph fill>
                    Feel free to shoot the Grommet team any feedback and questions by using this page footer contact
                    info.
                </Paragraph>
            ...
            <Footer background="light-2" pad={{ vertical: 'small', horizontal: 'medium' }}>
